...
try:
    from ansible_collections.ceph.cephadm.plugins.module_utils.ceph_common import exit_module, build_base_cmd_orch
except ImportError:
    try:
        from ansible.module_utils.ceph_common import exit_module, build_base_cmd_orch
    except ImportError:
