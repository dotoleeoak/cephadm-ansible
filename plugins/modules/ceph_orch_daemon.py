...
try:
    from ansible_collections.ceph.cephadm.plugins.module_utils.ceph_common import retry, exit_module, build_base_cmd_orch, fatal
except ImportError:
    try:
        from ansible.module_utils.ceph_common import retry, exit_module, build_base_cmd_orch, fatal
    except ImportError:
        from module_utils.ceph_common import retry, exit_module, build_base_cmd_orch, fatal
